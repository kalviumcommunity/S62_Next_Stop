...
function AddEntityPage(){
    ...
    >
        ...
        <div className="flex justify-between">
            <button
                type="submit"
                className="px-6 py-2 bg-emerald-500 text-gray-900 font-semibold rounded-lg shadow-md hover:bg-emerald-600 focus:outline-none focus:ring-2 focus:ring-emerald-400"
            >
                Submit
            </button>
            <button
